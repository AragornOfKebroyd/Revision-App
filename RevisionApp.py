...
class FlashcardPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.addFlashcardButton = tk.Button(self.flashFrame, text="Add New Flashcard")
        self.editFlashcardButton = tk.Button(self.flashFrame, text="Edit Flashcard")
        ...
        self.addFlashcardButton.grid()
        self.editFlashcardButton.grid()
